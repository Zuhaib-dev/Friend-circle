...
/* ─── page ───────────────────────────────────────────────── */
export function GalleryClient({ initialFrames, isAdmin }: { initialFrames: Frame[], isAdmin: boolean }) {
      ...
      <section className="hairline-b border-ink bg-bone sticky top-11 md:top-12 z-40">
        <div className="px-4 py-3 md:py-4">
          <div className="flex items-center gap-2 mb-3 mono-label">
            <span className="brick text-bone px-2 py-0.5">INTEL / 04</span>
          ...
          <>
            ...
            {!hasMore && filtered.length > 0 && (
              <div className="py-10 flex items-center justify-center mono-label opacity-40 gap-3">
                <span className="h-px flex-1 max-w-30 bg-ink/30" />
